  ...
  return (
    <div className="bg-gradient-to-b from-fuchsia-600 to-blue-300 rounded shadow-lg">
      <div className="profile text-center mb-8">
        ...
        <p>Honor your heritage! I have extensive experience capturing the beauty and traditions of diverse cultural weddings. Whether it's a vibrant Hindu ceremony or a classic Jewish chuppah, I'll document your special day with sensitivity and respect.</p>
      </div>
